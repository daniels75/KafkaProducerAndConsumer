...
public class TwitterBatchProducer {

    private static final Logger logger = LoggerFactory.getLogger(TwitterBatchProducer.class);
    ...
    static final List<String> terms = Lists.newArrayList("bitcoin", "usa", "virus", "sport");

    public TwitterBatchProducer() {

    }
    public static void main(String[] args)  {
        new TwitterBatchProducer().run();
    }
